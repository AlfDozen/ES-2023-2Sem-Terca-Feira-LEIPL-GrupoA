...
final class TimeSlot implements Comparable<TimeSlot> {
	...
	/**
	 * Verify if this TimeSlot overlaps a given TimeSlot by
	 * checking if this timeslots timeBegin is before the timeEnd given TimeSlot or
	 * this TimeSlot timeEnd is after the timeBegin of the given TimeSlot
	 * @param other The other TimeSlot to be verified.
	 * @return true is overlaps, false otherwise.
	 */
	public boolean overlaps(TimeSlot other) {
	    if (other == null || !other.isComplete() || this == null || !this.isComplete()) {
	        return false;
	    }
